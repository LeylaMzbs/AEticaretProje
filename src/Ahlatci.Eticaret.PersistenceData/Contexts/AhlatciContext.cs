...
using Ahlatci.Eticaret.Persistence.Mappings;
using Ahlatci.Eticaret.PersistenceData.Mappings;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.ChangeTracking;

namespace Ahlatci.Eticaret.Persistence.Context
{
    public class AhlatciContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //Entity türleri için isDeleted bilgisi false olanların otomatik olarak filtrelenmesi sağlanır.
